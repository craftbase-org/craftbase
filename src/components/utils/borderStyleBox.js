...
const BorderStyleBox = ({
      ...
      return (
        <Fragment key={index}>
          <button
            ...
            }  mx-2 hover:bg-blues-b400  font-semibold hover:text-white py-2 px-4 border border-blues-b400 hover:border-transparent rounded`}
          >
            {type.display}
          </button>
        </Fragment>
      ...
      return (
        <Fragment key={width}>
          <button
            ...
            } w-10 h-10  border-blues-b400 mx-2  bg-blues-b50 font-semibold py-2 rounded`}
          ></button>
        </Fragment>
      );
    });
  ...
  return (
    <Fragment>
      <BorderStyleBoxContainer className={`text-left p-1 `}>
        <label htmlFor="border-type-row">Type</label>
        <div
          id="border-type-row"
          data-parent="floating-toolbar"
        ...
        <hr className="my-4" />
        <label htmlFor="border-widths-row">Width</label>
        <div
